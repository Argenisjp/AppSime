...
//2nd paso)compose message
        try {
            ...
            message.setFrom(new InternetAddress(user));
            message.addRecipient(Message.RecipientType.TO, new InternetAddress(para));
            message.setSubject("Recordatorio Claves Sistema de Información Sime");

            message.setContent(
                    "<center><img src='https://funeraltech.com/wp-content/uploads/Password-opt-1080x675.jpg' title='SIME'></center>"
